...
<html lang="en">
<head>
  <title>Georgian Transliteration</title>
  <meta charset="utf-8">
...
<body>
	...
	<div id=content>
		...
		<h1>English-alphabet Georgian translation</h1>
        <br /><br /><br /><br />
		<div class="container">
            <form action="" method="post" runat="server">
                       
                
                        <input type="text" runat="server" id="englishIn" name="leftbox" placeholder="Gamarjoba gogo ra ginda?" >
            
                        <label for="lname">Output</label>
                        <input type="text" runat="server" id="georgianOut" name="rightbox" placeholder="გამარჯობა გოგო რა გინდა?">

                    <div class="tex-align align-content-center">
